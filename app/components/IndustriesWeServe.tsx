    ...
    <section className="py-12 md:py-16 bg-slate-900 text-white">
      <div className="max-w-6xl mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-4">
          {industries.map((industry, index) => {
            ...
            return (
              ...
              >
                <div className="w-8 h-8 md:w-10 md:h-10 mb-2 md:mb-3 p-1.5 md:p-2 bg-[#2DD4BF] rounded-lg group-hover:bg-brand transition-colors duration-300 flex items-center justify-center">
        ...
        <div className="mt-10 md:mt-12 text-center">
          ...
          <button className="bg-brand hover:bg-[#2DD4BF] text-white px-6 md:px-8 py-2.5 md:py-3 rounded-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 text-sm md:text-base">
